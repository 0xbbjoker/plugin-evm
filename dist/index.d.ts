import { IAgentRuntime, Provider, Memory, State, HandlerCallback, Action, Service, Plugin } from '@elizaos/core';
...
declare class WalletProvider {
    ...
    constructor(accountOrPrivateKey: PrivateKeyAccount | `0x${string}`, runtime: IAgentRuntime, chains?: Record<string, Chain>);
    getAddress(): Address;
    ...
    getWalletBalances(): Promise<Record<SupportedChain, string>>;
...
declare class EVMService extends Service {
